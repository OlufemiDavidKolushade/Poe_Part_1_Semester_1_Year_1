...
public class Message {
    ...
    public String createMessageHash() {
        ...
        return (idPrefix + ":" + (numMessagesSent + 1) + ":" +
    ...
    public String SentMessage() {
        ...
        switch (choice) {
            case "1":
                ...
                // regenerate hash after incrementing message count
                this.messageHash = createMessageHash();

                // add message to Manager storage
                Manager.addMessage(
                        "",
                        messageID,
                        recipient,
            ...
            case "3":
                ...
                storeMessageToTextFile();//Allows for storage procession
    ...
    private void storeMessageToTextFile() {
